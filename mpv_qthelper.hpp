...
static inline QVariant data_to_variant(mpv_format format, void *data)
{
    switch (format) {
    case MPV_FORMAT_STRING:
        return QVariant(QString::fromUtf8(*reinterpret_cast<char**>(data)));
    case MPV_FORMAT_FLAG:
        return QVariant(static_cast<bool>(*reinterpret_cast<int*>(data)));
    case MPV_FORMAT_INT64:
        return QVariant(static_cast<qlonglong>(*reinterpret_cast<int*>(data)));
    case MPV_FORMAT_DOUBLE:
        return QVariant(*reinterpret_cast<double*>(data));
    default:
        return QVariant();
    }
}
...
static inline QVariant node_to_variant(const mpv_node *node)
{
    ...
    case MPV_FORMAT_INT64:
    case MPV_FORMAT_DOUBLE:
        return data_to_variant(node->format, (void*)&node->u);
